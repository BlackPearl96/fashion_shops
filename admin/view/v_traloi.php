...
<div id="form-wrapper">
    <form method="post" action="">
        <div id="form-inner">
            ...
            <input type="text" class="input" name="name" value="<?php echo $_SESSION["user"]; ?>">
        
            <label for="email">Email nhận:</label>
            <input type="email" class="input" name="email" value="<?php echo isset($arr["email"])? $arr["email"]:""; ?>">
        
            <label for="message">Message:</label>
            <textarea class="input textarea" name="message" placeholder="Your message here"></textarea>    
